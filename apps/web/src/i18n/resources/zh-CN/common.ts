const zhCNCommon = {
  ...
  pages: {
    ...
    dataImport: {
      ...
      importSuccessWithDetail: "导入成功：{{message}}",
      importPartialWithDetail: "部分导入成功：{{message}}",
      resetUpload: "重新上传",
      continueUpload: "继续上传",
    ...
    packagingRule: {
      ...
      form: {
        ...
        emptyDetails: "暂无层级明细，请点击「选择层级明细」按钮选择。",
        ...
        replaceDetailsConfirmTitle: "替换现有层级明细？",
        replaceDetailsConfirmDescription: "选择层级后将覆盖当前明细，是否继续？",
      },
      feedback: {
