const enUSCommon = {
  ...
  aiChat: {
    ...
    description: "Answers production questions using read-only MES data.",
    close: "Close",
    newConversation: "New conversation",
    history: "Conversation history",
    empty: "Create a conversation, then ask about today's output, completed work orders, or other MES data.",
    inputLabel: "Question",
    placeholder: "Ask about MES data",
    send: "Send",
    stop: "Stop",
    retry: "Retry",
    generating: "Generating…",
    evidence: "Query evidence",
    evidenceMeta: "{{rows}} rows · {{duration}} ms",
    timeRange: "Time range: {{start}} to {{end}}",
    dataCutoff: "Data cutoff: {{value}}",
    truncated: "Result truncated",
    deleteConversation: "Delete {{title}}",
    deleteConfirmTitle: "Delete this conversation?",
    deleteConfirmDescription: "The conversation will be hidden while audit records remain available.",
    serviceUnavailable: "The AI service is unavailable. Try again later.",
  ...
  pages: {
    ...
    dataImport: {
      ...
      importPartial: "Partial import success",
      importSuccessWithDetail: "Import successful: {{message}}",
      importPartialWithDetail: "Partial import success: {{message}}",
